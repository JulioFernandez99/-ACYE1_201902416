...
main proc
      ...
      start_game:
        ...
        imprimir_ganador:
            ...
            JE ganador_j1
        ganador_j2:
            mPrintTextIntoVideo 0Dh,  00, mensaje_ganado_j2, 24, 000F
            pauseUntilEnter
            JMP inicio
        ganador_j1:
            mPrintTextIntoVideo 0Dh,  00, mensaje_ganado_j1, 24, 000F
            pauseUntilEnter
            JMP inicio
